...
class Config(BaseSettings):
    ...
    # CORS settings
    allowed_origins: str = (
        "http://localhost:7377,http://localhost:5173,http://0.0.0.0:7377,http://0.0.0.0:5173,http://127.0.0.1:7377,http://127.0.0.1:5173,https://chat.hananasghar.site"  # comma separated list of origins
    )
